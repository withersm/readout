...
@Dev Notes: sheeeeiiiittttttttttttt
...
class DataFile:
    ...
    def __create_hdf5_file(self, filename: str, num_packets: int, num_tones: int):
        ...
        self.obs_adc_i_data = data_file.create_dataset(
            "observation_data/adc_i",
        ...
        self.obs_adc_q_data = data_file.create_dataset(
            "observation_data/adc_q",
            (DETECTOR_DATA_LENGTH / 2, num_packets),
            dtype=h5py.h5t.NATIVE_UINT32,
            chunks=True,
        )
        ...
        self.obs_azimuth = data_file.create_dataset(
            "observation_data/azimuth", (1, num_packets), dtype=h5py.h5t.NATIVE_DOUBLE
        )
        self.obs_azimuth.attrs.create("units", "degrees")
        self.obs_azimuth.attrs.create("dimension_names", "azimuth, packet_number")

        self.obs_elevation = data_file.create_dataset(
            "observation_data/elevation", (1, num_packets), dtype=h5py.h5t.NATIVE_DOUBLE
        )
        self.obs_elevation.attrs.create("units", "degrees")
        self.obs_elevation.attrs.create("dimension_names", "elevation, packet_number")

        self.obs_lofreq = data_file.create_dataset(
            "observation_data/lofrequency",
            (1, num_packets),
        ...
        self.obs_timestamp = data_file.create_dataset(
        ...
        self.oth_atten = data_file.create_dataset(
            "other_variables/attenuator_settings",
            dtype=h5py.h5t.NATIVE_DOUBLE,
            shape=(4, 1),
        )
        self.oth_atten.attrs.create("units", "dB")

        self.oth_bbfreq = data_file.create_dataset(
            "other_variables/baseband_freqs",
            dtype=h5py.h5t.NATIVE_DOUBLE,
            shape=(num_tones, 1),
        )
        self.oth_chanmask = data_file.create_dataset(
            "other_variables/channel_mask",
            dtype=h5py.h5t.NATIVE_INT32,
            shape=(num_tones, 1),
        )
        self.oth_deltax = data_file.create_dataset(
            "other_variables/detector_delta_x",
            dtype=h5py.h5t.NATIVE_DOUBLE,
            shape=(num_tones, 1),
        )
        self.oth_deltay = data_file.create_dataset(
            "other_variables/detector_delta_y",
            dtype=h5py.h5t.NATIVE_DOUBLE,
            shape=(num_tones, 1),
        )
        self.oth_globaz = data_file.create_dataset(
            "other_variables/global_delta_azimuth", dtype=h5py.h5t.NATIVE_DOUBLE
        )
        self.oth_globel = data_file.create_dataset(
            "other_variables/global_delta_elevation", dtype=h5py.h5t.NATIVE_DOUBLE
        )
        self.oth_samplerate = data_file.create_dataset(
            "other_variables/sample_rate", dtype=h5py.h5t.NATIVE_DOUBLE
        )
        self.oth_timenum = data_file.create_dataset(
            "other_variables/tile_number",
            dtype=h5py.h5t.NATIVE_UINT32,
            shape=(num_tones, 1),
        )
        self.oth_tonepw = data_file.create_dataset(
            "other_variables/tone_power",
            dtype=h5py.h5t.NATIVE_DOUBLE,
            shape=(num_tones, 1),
        )
        self.oth_collectionType = data_file.create_dataset(
            "other_variables/collection_type", dtype=h5py.h5t.STRING
        )
