...
# ------ NOTE: integrating new "read_data" function here!!! -------- 
...
def read_data(filename, chunk='all', chunk_start=None, chunk_stop=None, single_channel=None):
    ...
    return t, adc_i, adc_q, ch # this function will now have 4 outputs instead of 3
...
def full_demod_process(ts_file, f_sawtooth, method = 'fft', correct_phase_jumps = False, phase_jump_threshold = 0.4, n=0, channels='all',start_channel=0,stop_channel=1000,tone_init_path = '/home/matt/alicpt_data/tone_initializations', ts_path = '/home/matt/alicpt_data/time_streams', display_mode = 'terminal'):
    ...
    if channels == 'some':
        ...
        print(tone_freqs)
    ts_fr,Is_fr,Qs_fr,chans=read_data(ts_path,chunk='all',chunk_start=start_channel,chunk_stop=stop_channel, single_channel=None)    #note to self: limit tone_freqs to actively called channels; need to figure out channel numbering first
    
    print('Channels being demodulated' + str(chans))
